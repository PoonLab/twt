...
## Description
[treeswithintrees](http://github.com/PoonLab/twt) (*twt*) is an R package for the [coalescent](https://en.wikipedia.org/wiki/Coalescent_theory) (reverse time) simulation of host (transmission) trees and pathogen trees within host trees.
It is designed to be flexible so that it can accommodate a range of models at different levels of diversity, such as:
...
```
For details instructions, please refer to [INSTALL.md](INSTALL.md).
